...
export default function LoanCard({
  ...
  return (
    ...
    >
      ...
      {loan.status !== "Closed" && loan.pendingMissed && (
      ...
      {loan.status !== "Closed" && loan.pendingMissed && (
        <div className="mt-4 p-3 bg-rose-50 border border-rose-100 rounded-2xl flex items-start gap-2.5">
      ...
      {loan.status !== "Closed" && (
        <div className="mt-5 pt-4 border-t border-slate-50 flex gap-2.5">
          ...
          >
            {loan.pendingMissed ? "Resume Sync" : "Skip / Pause Month"}
          </button>
